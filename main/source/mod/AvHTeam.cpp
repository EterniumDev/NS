...
void AvHTeam::InitializeTechNodes()
{
	...
	else
	{
		...
		if(this->mTeamType == AVH_CLASS_TYPE_MARINE)
		{
			...
			if (avh_modmotiontracking.value == 0)
			{
			...
			{
				this->mTechSlotManager.AddTechSlots(AvHTechSlots(AVH_USER3_OBSERVATORY, BUILD_SCAN, RESEARCH_PHASETECH, MESSAGE_NULL, MESSAGE_NULL, RESEARCH_DISTRESSBEACON, MESSAGE_NULL, MESSAGE_NULL, BUILD_RECYCLE));
			}
